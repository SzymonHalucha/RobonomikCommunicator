...
class Layout(ISerialize):
    ...
    def deserialize(self, dict: "dict") -> "Layout":
        ...
        self.controllers: "list[Controller]" = [Controller().deserialize(controller) for controller in dict["controllers"]]
        return self

    def get_controller(self, controller_name: "str") -> "Controller | None":
