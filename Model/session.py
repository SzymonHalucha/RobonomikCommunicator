...
class Session(ISerialize):
    ...
    def edit_variable(self, old: "Variable", new: "Variable") -> "Variable":
    ...
    def get_layout_by_name(self, layout_name: "str") -> "Layout":
    ...
    def edit_controller(self, old: "Controller", new: "Controller", copy_position: "bool" = True) -> "Controller":
        if copy_position:
